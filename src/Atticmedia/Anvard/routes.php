...
if (Config::get('anvard::routes.index')) {
    Route::get(
        Config::get('anvard::routes.index','anvard'),
        array(
...
if (Config::get('anvard::routes.login')) {
    Route::get(
        Config::get('anvard::routes.login','anvard/login/{provider}'),
        array(
...
{
    Route::get(
		Config::get('anvard::routes.logout','anvard/logout/{provider}'),
		array(
...
if (Config::get('anvard::routes.endpoint')) {
    Route::get(
		Config::get('anvard::routes.endpoint','anvard/endpoint'),
		array(
